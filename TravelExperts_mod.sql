...
INSERT [dbo].[Packages] ([PackageId], [PkgName], [PkgStartDate], [PkgEndDate], [PkgDesc], [PkgBasePrice], [PkgAgencyCommission], [PkgImage], [AlternateText]) VALUES (1, N'Caribbean New Year', CAST(0x0000973500000000 AS DateTime), CAST(0x0000973F00000000 AS DateTime), N'Cruise the Caribbean & Celebrate the New Year.', 4800.0000, 400.0000, 'caribbean.jpg', '')
INSERT [dbo].[Packages] ([PackageId], [PkgName], [PkgStartDate], [PkgEndDate], [PkgDesc], [PkgBasePrice], [PkgAgencyCommission], [PkgImage], [AlternateText]) VALUES (2, N'Polynesian Paradise', CAST(0x0000972800000000 AS DateTime), CAST(0x0000973000000000 AS DateTime), N'8 Day All Inclusive Hawaiian Vacation', 3000.0000, 310.0000, 'sloth.jpg', '')
INSERT [dbo].[Packages] ([PackageId], [PkgName], [PkgStartDate], [PkgEndDate], [PkgDesc], [PkgBasePrice], [PkgAgencyCommission], [PkgImage], [AlternateText]) VALUES (3, N'Asian Expedition', CAST(0x000097C100000000 AS DateTime), CAST(0x000097CF00000000 AS DateTime), N'Airfaire, Hotel and Eco Tour.', 2800.0000, 300.0000, 'bungalows.jpg', '')
INSERT [dbo].[Packages] ([PackageId], [PkgName], [PkgStartDate], [PkgEndDate], [PkgDesc], [PkgBasePrice], [PkgAgencyCommission], [PkgImage], [AlternateText]) VALUES (4, N'European Vacation', CAST(0x000096FF00000000 AS DateTime), CAST(0x0000970C00000000 AS DateTime), N'Euro Tour with Rail Pass and Travel Insurance', 3000.0000, 280.0000, 'rail.jpg', '')
...
CREATE TABLE [dbo].[Customers](
	...
	[AgentId] [int] NULL,
	[CustAccount] [nvarchar](50) NULL,
	[CustPassword] [nvarchar](50) NULL,
